...
import FamilyModelContainer from "@/components/FamilyModelContainer";
...
export default function ModelHome({result}) {
    ...
    const { marka, rodzina, model, typ_nadwozia, liczba_drzwi, rok_uruch, rok_zakoncz} = loadedBrands[0];

    const title = `AUTO-ERA - Twój profesjonalny portal motoryzacyjny - Katalog samochodów seryjnych - ${marka} ${rodzina} ${model} ${typ_nadwozia} ${liczba_drzwi}-drzwiowy (${rok_uruch}-${rok_zakoncz})`;
    ...
    return (
        <>
            ...
            <Container maxWidth="xl" sx={{bgcolor: '#FFFECC', color: '#153F1A'}}>
                ...
                <FamilyModelContainer model={loadedBrands[0]} gallery={loadedBrands[2]}/>

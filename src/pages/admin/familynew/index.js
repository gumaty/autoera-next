...
const title = "Dodaj nową rodzinę";

export default function BrandNewHome() {

    function addHandler(brandData) {
        fetch(
            'https://autoera-64fe0-default-rtdb.europe-west1.firebasedatabase.app/rodziny.json',
            {
                method: 'POST',
            ...
            <Container maxWidth="xl" sx={{bgcolor: '#FFFECC', color: '#153F1A'}}>
                <Box sx={{p: '20px', bgcolor: 'white'}} >
                    ...
                    <Box sx={{width: {xs: 1, sm: 0.9} , marginInline: 'auto', p: '30px', bgcolor: 'white', border: 1, borderRadius: 5, borderColor: '##153F1A', boxShadow: 10}} >
                        <AddFamilyForm onAddFamily={addHandler} />
                    </Box>
                </Box>
            </Container>
        </>

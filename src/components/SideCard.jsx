	...
	return (
		<>
			<Link
				...
				href={`/seryjne/${cardSql.nazwa_marka}/${cardSql.nazwa_typ}`}
			>
				<div className={styles.cardContainer}>
					<img
						className={imgstyles.tnstyle}
						src={`http://server090121.nazwa.pl/images/family/${cardSql.img_typ}.webp`}
						alt={updateTitle}
						loading='lazy'
					/>
					<h2>
						{cardSql.nazwa_marka} {cardSql.nazwa_typ}
					</h2>

					...
					{generacje
						...
						.map((generacja) => (
							...
							>
								...
								>
									<img className={imgstyles.tnstyle}
										src={`http://server090121.nazwa.pl/images/family/tn/${generacja.img_gener}.webp`}
										alt={`Miniatura ${generacja.marka_gener} ${generacja.typ_gener} ${generacja.gen_gener}`}
										loading='lazy'
									/>
									<Typography
										sx={{

				...
				<AccordionDetails>
					{loadedBrands.map((item) => (
						<Accordion
							...
							expanded={expanded === `${item.marka}`}
							onChange={handleChange(`${item.marka}`)}
						>
							<AccordionSummary
								expandIcon={<ExpandMoreIcon />}
								aria-controls='panel1a-content'
										...
										<AccordionDetails key={key}>
											...
											>
												<img
													...
													src={`http://server090121.nazwa.pl/images/studio/${value.picture}.webp`}
													alt={`Miniatura ${value.marka} ${value.model}`}

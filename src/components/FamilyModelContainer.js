...
function FamilyModelContainer({ model, gallery }) {
    ...
    return (
        <Box sx={{display: "flex", flexDirection: "column", p: '20px', bgcolor: 'white'}} >
            <Box sx={{mb:2, px: 2, py: 1, display:'block', borderLeft: 10, borderColor: 'red'}}>
                ...
                <Typography variant='h5' component='h1' sx={{color: '#153F1A', fontWeight: '700'}}>{model.marka} {model.rodzina} {model.model} {model.typ_nadwozia} {model.liczba_drzwi}-drzwiowy ({model.rok_uruch}-{model.rok_zakoncz})</Typography>
            </Box>
...
export default FamilyModelContainer;